    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 6,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handleLastNameChange))
        }
      }, [])]), api_element("div", {
        classMap: {
          "slds-col": true
        ...
        key: 8,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.handlefirstNameChange))
        }
      }, [])])]), api_custom_element("lightning-input", _lightningInput, {
        classMap: {
          "slds-m-bottom_x-small": true
        ...
        key: 9,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.handleEmailChange))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        classMap: {
          "slds-m-bottom_x-small": true
        ...
        key: 15,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.saveUser))
        }
      }, []), api_text("\xA0\xA0\xA0"), $cmp.canreset ? api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "success",
        ...
        key: 17,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.navigateToWebPage))
        }
      }, []) : null, !$cmp.canreset ? api_custom_element("lightning-button", _lightningButton, {
        props: {
          "variant": "success",
          "iconName": "utility:reset_password",
          "disabled": true,
    ...
    tmpl$m.stylesheetTokens = {
      hostAttribute: "lwc-registForm_registForm-host",
      shadowAttribute: "lwc-registForm_registForm"
    };
    ...
    const apexInvoker = lds.getApexInvoker("", "registFormController", "chatterProfileId", false);
    wireService.register(apexInvoker, lds.generateGetApexWireAdapter("", "registFormController", "chatterProfileId", false));

    const apexInvoker$1 = lds.getApexInvoker("", "registFormController", "IsAreadyExist", false);
    wireService.register(apexInvoker$1, lds.generateGetApexWireAdapter("", "registFormController", "IsAreadyExist", false));

    var USER_OBJECT = {"objectApiName":"User"};

    var COMMUNITYNICKNAME_FIELD = {"fieldApiName":"CommunityNickname","objectApiName":"User"};

    var FIRSTNAME_FIELD = {"fieldApiName":"FirstName","objectApiName":"User"};

    var LASTNAME_FIELD = {"fieldApiName":"LastName","objectApiName":"User"};

    var USERNAME_FIELD = {"fieldApiName":"Username","objectApiName":"User"};

    var EMAIL_FIELD = {"fieldApiName":"Email","objectApiName":"User"};

    var ALIAS_FIELD = {"fieldApiName":"Alias","objectApiName":"User"};

    var PROFILEID_FIELD = {"fieldApiName":"ProfileId","objectApiName":"User"};

    var LOCALESIDKEY_FIELD = {"fieldApiName":"LocaleSidKey","objectApiName":"User"};

    var TIMEZONESIDKEY_FIELD = {"fieldApiName":"TimeZoneSidKey","objectApiName":"User"};

    var LANGUAGELOCALEKEY_FIELD = {"fieldApiName":"LanguageLocaleKey","objectApiName":"User"};

    var EMAILENCODINGKEY_FIELD = {"fieldApiName":"EmailEncodingKey","objectApiName":"User"};

    const DELAY = 500;

    class RegistForm extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.userId = void 0;
      ...
      saveUser() {
        ...
        lds.createRecord(recordInput).then(User => {
          this.canreset = true;
        }).catch(error => {
    ...
    lwc.registerDecorators(RegistForm, {
      wire: {
        wiregetProfileid: {
          adapter: apexInvoker,
          method: 1
    ...
    var registForm = lwc.registerComponent(RegistForm, {
      tmpl: _tmpl$l
    });
